...
if __name__ == '__main__':
    ...
    parser.add_argument('--filename', default="248-parse", help="model name: Context Guided Network (CGNet)")
    parser.add_argument('--model', default="tapnet", help="model name: Hierarchically Aggregated Narrow Dilated Network (HANDNet)")
